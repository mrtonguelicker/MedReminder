//NO INSPECTION, errors will be resolved when merging into dev
...
public class TodayFragment extends Fragment implements TodayAdapter.OnDoseActionListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new TodayAdapter(medicationList, statusList, this);
    ...
    private void loadTodayData() {
        ...
        for (Medication med : allMeds) {
            if (med.isActive()) {
                ...
                statusList.add(prefsHelper.geTodayStatus(med.getId()));
            }
        }
    }
    ...
    private void checkRefills(List<Medication> meds) {
        ...
        if ((!lowMeds.isEmpty())) {
            ...
            tvRefillMessage.setText(String.json("\n", lowMeds));
        } else {
